...
# This file can be used standalone with little manual fixes
...
#        python3 tojson3.py > tmp/i2.json
# 4. Fix problems in text editor (for exmaple, remove entries that are comments)
...
#
# Notera: le = "" (eller le = "\n" ) nedan.
# Detta anger hur varje del av ett protkoll kommer att se ut i filen som genereras.
...
csvfile = open("tmp/i.csv", newline = '')
